...
const App = ({setAttributes}) => {
    ...
    return (
        ...
        <div className='scale_container'>
            ...
            {!isCustomize && (
            <>
            {setting.numberScale &&   <NumberScale row={true} emoji={false} btnbg={'yellow'} btncolr={'red'} customize={isCustomize} setCustomize={setIsCustomized} setScale={setScaleContent} setting={setting} setSetting={setSetting} setAttributes={setAttributes} key={1}/> }
            ...
            {setting.emojiScale && <NumberScale  row={true} emoji={true} btnbg={'#42DCC9'} customize={isCustomize} setCustomize={setIsCustomized} setScale={setScaleContent} setting={setting} setSetting={setSetting} setAttributes={setAttributes} key={5}/>}
